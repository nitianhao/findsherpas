    ...
    <div className="py-6 sm:py-10">
      ...
      <div className="max-w-2xl">
        <div className="flex items-center gap-2.5">
          <Calendar size={18} strokeWidth={1.5} className="shrink-0 text-muted-foreground" />
      ...
      <div className="mt-6 sm:mt-10 max-w-[600px]">
        ...
        <div className="mt-4 grid gap-6 sm:grid-cols-2">
          <div>
            <p className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">Good fit</p>
            <ul className="mt-2 space-y-2 text-sm text-foreground/80">
              <li className="flex items-baseline gap-2"><span className="text-muted-foreground/70">&bull;</span>Ecommerce or marketplace sites with large catalogs</li>
              <li className="flex items-baseline gap-2"><span className="text-muted-foreground/70">&bull;</span>Teams trying to improve search relevance or ranking</li>
              <li className="flex items-baseline gap-2"><span className="text-muted-foreground/70">&bull;</span>Search systems with synonyms, boosting, or merchandising rules</li>
            </ul>
          </div>
          <div>
            <p className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">Probably not a fit</p>
            <ul className="mt-2 space-y-2 text-sm text-foreground/80">
              <li className="flex items-baseline gap-2"><span className="text-muted-foreground/70">&bull;</span>Very small catalogs where search plays a minor role</li>
              <li className="flex items-baseline gap-2"><span className="text-muted-foreground/70">&bull;</span>Sites with very low search usage</li>
              <li className="flex items-baseline gap-2"><span className="text-muted-foreground/70">&bull;</span>Teams looking for ongoing implementation work</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-[600px]">
        ...
        <div className="mt-8 border-t border-border/40 pt-6">
          <div className="flex items-center gap-2">
            <Mail size={18} strokeWidth={1.5} className="shrink-0 text-muted-foreground" />
